...
export default function PlaceDetailScreen({ route }: Props) {
  const { place } = route.params || ({} as any);

  if (!place) {
    return (
      <View style={styles.errorContainer}>
        <Text style={styles.errorTitle}>Lieu introuvable</Text>
        <Text style={styles.errorText}>
          Retourne à l’onglet Découverte ou à la Carte et sélectionne un lieu.
        </Text>
      </View>
    );
  }
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          {place.description ||
            "Un lieu culturel à découvrir au cœur de Paris. Profite de l'architecture et de l'ambiance pour créer ton souvenir."}
        </Text>
